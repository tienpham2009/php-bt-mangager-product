...
<form method="post" enctype="multipart/form-data">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputEmail1" name="productCode">
        <?php if (isset($errors)):?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputPassword1" name="productName" >
        <?php if (isset($errors)):?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputPassword1" name="productDescription">
    </div>
    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Producer</label>
        <input type="text" class="form-control" id="exampleInputPassword1" name="producer">
        <?php if (isset($errors)):?>
